...
struct  CEntityInstance {
    ...
    char m_pEntity[24];
    void* m_CScriptComponent;
    bool m_bVisibleinPVS; // Size: 0
};
...
struct  CGameSceneNode {
    ...
    void* m_pParent;
    void* m_pChild;
    char m_pNextSibling[48];
    char m_hParent[16];
    char m_vecOrigin[56];
    char m_angRotation[12];
    float32 m_flScale; // Size: 4
    Vector m_vecAbsOrigin; // Size: 12
    char m_angAbsRotation[12];
    ...
    bool m_bForceParentToBeNetworked; // Size: 0
    char m_bDirtyHierarchy[0];
    char m_bDirtyBoneMergeInfo[0];
    char m_bNetworkedPositionChanged[0];
    char m_bNetworkedAnglesChanged[0];
    char m_bNetworkedScaleChanged[0];
    char m_bWillBeCallingPostDataUpdate[0];
    char m_bBoneMergeFlex[0];
    char m_nLatchAbsOrigin[0];
    ...
    Vector m_vRenderOrigin; // Size: 0
};

struct  CBodyComponent {
    char m_pad[8];
    char m_pSceneNode[24];
    char __m_pChainEntity[0];
};
...
struct  CLightComponent {
    ...
    char m_vPrecomputedOBBAngles[12];
    ...
    float32 m_flMinRoughness; // Size: 0
};
...
struct  CRenderComponent {
    ...
    char m_pad79_176[79];
    bool m_bInterpolationReadyToDraw; // Size: 0
};
...
struct  CPropDataComponent {
    ...
    int32 m_nMotionDisabledSpawnFlag; // Size: 0
};
...
struct __declspec(align(8)) C_TonemapController2 {
    ...
    float32 m_flTonemapEVSmoothingRange; // Size: 0
};
...
struct __declspec(align(8)) C_PostProcessingVolume {
    ...
    float32 m_flTonemapPercentTarget; // Size: 4
    float32 m_flTonemapPercentBrightPixels; // Size: 4
    float32 m_flTonemapMinAvgLum; // Size: 0
};
...
struct __declspec(align(8)) C_FogController {
    ...
    char m_pad3_1492[3];
    int32 m_iChangedVariables; // Size: 0
};

struct  CPlayer_CameraServices {
    char m_pad[64];
    char m_vecCsViewPunchAngle[12];
...
struct  CPlayer_ObserverServices {
    ...
    char m_flObserverChaseDistanceCalcTime[0];
};
...
struct  CBaseAnimGraphController {
    char m_pad[24];
    char m_animGraphNetworkedVars[5264];
    ...
    char m_pad3_5336[3];
    char m_flPrevAnimUpdateTime[0];
};

struct  CBodyComponentBaseAnimGraph {
    char m_pad[1168];
    char m_animationController[0];
};
...
struct __declspec(align(8)) C_BaseModelEntity {
    char m_pad[2640];
    void* m_CRenderComponent;
    char m_CHitboxComponent[40];
    ...
    bool m_bUseClientOverrideTint; // Size: 0
};
...
struct  ActiveModelConfig_t {
    ...
    char m_AssociatedEntityNames[0];
};
...
struct  SequenceHistory_t {
    ...
    float32 m_flCyclesPerSecond; // Size: 0
};
...
struct  CNetworkedSequenceOperation {
    ...
    float32 m_flPrevCycleForAnimEventDetection; // Size: 0
};
...
struct  CModelState {
    ...
    int8 m_nClothUpdateFlags; // Size: 0
};
...
struct  CAnimGraphNetworkedVariables {
    ...
    float32 m_flLastTeleportTime; // Size: 0
};
...
struct  CCollisionProperty {
    ...
    float32 m_flCapsuleRadius; // Size: 0
};
...
struct __declspec(align(8)) C_BaseFire {
    ...
    uint32 m_nFlags; // Size: 0
};

struct  TimedEvent {
    float32 m_TimeBetweenEvents; // Size: 4
    char m_pad[4];
    float32 m_fNextEvent; // Size: 0
};
...
struct __declspec(align(8)) C_FireSmoke {
    ...
    char m_pad2_1456[2];
    void* m_tParticleSpawn;
    char m_pFireOverlay[0];
};
...
struct __declspec(align(8)) C_RopeKeyframe {
    ...
    bool m_bConstrainBetweenEndpoints; // Size: 0
    char m_bEndPointAttachmentPositionsDirty[0];
    char m_bEndPointAttachmentAnglesDirty[0];
    char m_bNewDataThisFrame[0];
    char m_bPhysicsInitted[0];
};
...
struct  VPhysicsCollisionAttribute_t {
    ...
    uint8 m_nCollisionFunctionMask; // Size: 0
};
...
struct  CDecalInfo {
    ...
    void* m_pNext;
    char m_pPrev[136];
    int32 m_nDecalMaterialIndex; // Size: 0
};
...
struct  shard_model_desc_t {
    ...
    char m_pad2_120[2];
    char m_SurfacePropStringToken[0];
};
...
struct  C_EconItemView {
    ...
    char m_pad18_528[18];
    char m_AttributeList[96];
    char m_NetworkedDynamicAttributes[96];
    char m_szCustomName[161];
    char m_szCustomNameOverride[207];
    bool m_bInitializedTags; // Size: 0
};
...
struct  C_AttributeContainer {
    ...
    char m_pad4_1184[4];
    uint64 m_ullRegisteredAsItemID; // Size: 0
};

struct  C_EconEntity::AttachedModelData_t {
    int32 m_iModelDisplayFlags; // Size: 0
};
...
struct  C_CSGameRules {
    ...
    void* m_pGameModeRules;
    char m_RetakeRules[280];
...
struct  CSPerRoundStats_t {
    ...
    int32 m_iEnemiesFlashed; // Size: 0
};
...
struct  CSMatchStats_t {
    ...
    int32 m_iEnemyTaserKills; // Size: 0
};
...
struct  C_CSGO_TeamPreviewCharacterPosition {
    ...
    char m_agentItem[1096];
    char m_glovesItem[1096];
    char m_weaponItem[0];
};
...
struct  PredictedDamageTag_t {
    ...
    float32 flFriendlyFireDamageReductionRatio; // Size: 0
};

struct __declspec(align(16)) C_CSPlayerPawn {
    char m_pad[5400];
    void* m_pBulletServices;
    void* m_pHostageServices;
    void* m_pBuyServices;
    void* m_pGlowServices;
    void* m_pActionTrackingServices;
    void* m_pDamageReactServices;
    ...
    char m_pad2_5508[2];
    char m_aimPunchAngle[12];
    char m_aimPunchAngleVel[12];
    ...
    char m_pad3_9264[3];
    char m_angStashedShootAngles[12];
    ...
    int32 m_nHighestAppliedDamageTagTick; // Size: 0
};
...
struct __declspec(align(8)) C_PlayerPing {
    ...
    char m_szPlaceName[0];
};

struct  CCSPlayer_PingServices {
    char m_pad[64];
    char m_hPlayerPing[0];
};
...
struct __declspec(align(8)) C_CSPlayerResource {
    ...
    bool m_foundGoalPositions; // Size: 0
};
...
struct  CCSPlayerBase_CameraServices {
    ...
    char m_hZoomOwner[4];
    float32 m_flLastShotFOV; // Size: 0
};

struct  WeaponPurchaseCount_t {
    char m_pad[48];
    uint16 m_nItemDefIndex; // Size: 2
    uint16 m_nCount; // Size: 0
};

struct  WeaponPurchaseTracker_t {
    char m_pad[8];
    char m_weaponPurchases[0];
};
...
struct  CCSPlayer_ActionTrackingServices {
    ...
    char m_pad3_72[3];
    char m_weaponPurchasesThisMatch[88];
    char m_weaponPurchasesThisRound[0];
};

struct  CCSPlayer_BulletServices {
    char m_pad[64];
    int32 m_totalHitsOnServer; // Size: 0
};
...
struct  CCSPlayer_BuyServices {
    char m_pad[64];
    char m_vecSellbackPurchaseEntries[0];
};
...
struct  CCSPlayer_CameraServices {
    ...
    char m_pad4_560[4];
    Vector m_vClientScopeInaccuracy; // Size: 0
};

struct  CCSPlayer_HostageServices {
    char m_pad[64];
    char m_hCarriedHostage[4];
    char m_hCarriedHostageProp[0];
};
...
struct  CCSPlayer_MovementServices {
    ...
    float32 m_flMaxJumpHeightLastJump; // Size: 0
};
...
struct  CCSPlayer_WaterServices {
    ...
    float32 m_flSwimSoundTime; // Size: 0
};
...
struct  CCSPlayer_WeaponServices {
    ...
    uint32 m_nOldInputHistoryCount; // Size: 0
};
...
struct  CCSObserver_ObserverServices {
    ...
    bool m_bObserverInterpolationNeedsDeferredSetup; // Size: 0
};
...
struct  CCSPlayerController_ActionTrackingServices {
    ...
    char m_matchStats[128];
    int32 m_iNumRoundKills; // Size: 4
    int32 m_iNumRoundKillsHeadshots; // Size: 4
    uint32 m_unTotalRoundDamageDealt; // Size: 0
};

struct __declspec(align(8)) CCSPlayerController {
    char m_pad[1824];
    void* m_pInGameMoneyServices;
    void* m_pInventoryServices;
    void* m_pActionTrackingServices;
    void* m_pDamageServices;
    ...
    bool m_bIsPlayerNameDirty; // Size: 0
};
...
struct  CCSPlayerController_InGameMoneyServices {
    ...
    int32 m_iCashSpentThisRound; // Size: 0
};
...
struct  CCSPlayerController_InventoryServices {
    ...
    char m_vecServerAuthoritativeWeaponSlots[0];
};
...
struct  C_IronSightController {
    ...
    char m_angViewLast[12];
    void* m_vecDotCoords;
    float32 m_flDotBlur; // Size: 4
    float32 m_flSpeedRatio; // Size: 0
};
...
struct __declspec(align(8)) CompositeMaterialInputLooseVariable_t {
    ...
    int32 m_nPanoramaRenderRes; // Size: 0
};
...
struct __declspec(align(8)) CompositeMaterialInputContainer_t {
    ...
    bool m_bExposeExternally; // Size: 0
};
...
struct __declspec(align(8)) CompositeMaterialAssemblyProcedure_t {
    ...
    char m_vecPropertyMutators[0];
};

struct  GeneratedTextureHandle_t {
    char m_strBitmapName[0];
};
...
struct __declspec(align(8)) CompositeMaterialEditorPoint_t {
    ...
    char m_vecCompositeMaterials[0];
};
...
struct __declspec(align(16)) C_GlobalLight {
    char m_pad[2608];
    uint16 m_WindClothForceHandle; // Size: 0
};
...
struct  C_CSGO_PreviewModel_GraphController {
    ...
    char m_pszEndOfMatchCelebration[0];
};
...
struct __declspec(align(8)) C_CSGO_MapPreviewCameraPathNode {
    ...
    Vector m_vOutTangentWorld; // Size: 0
};
...
struct __declspec(align(8)) C_CSGO_MapPreviewCameraPath {
    ...
    float32 m_flPathDuration; // Size: 0
};
...
struct  C_CSGO_TeamPreviewCamera {
    ...
    float32 m_flDofFarCrisp; // Size: 4
    float32 m_flDofFarBlurry; // Size: 4
    float32 m_flDofTiltToGround; // Size: 0
};
...
struct __declspec(align(8)) C_CsmFovOverride {
    char m_pad[1384];
    void* m_cameraName;
    float32 m_flCsmFovOverrideValue; // Size: 0
};
...
struct  C_Chicken_GraphController {
    ...
    float32 m_flSquatProbability; // Size: 0
};
...
struct __declspec(align(8)) C_GradientFog {
    ...
    bool m_bGradientFogNeedsTextures; // Size: 0
};
...
struct __declspec(align(8)) C_EnvVolumetricFogVolume {
    ...
    bool m_bAllowLPVIndirect; // Size: 0
};
...
struct __declspec(align(8)) CInfoWorldLayer {
    ...
    bool m_bWorldLayerActuallyVisible; // Size: 0
};

struct __declspec(align(8)) CPointChildModifier {
    char m_pad[1384];
    bool m_bOrphanInsteadOfDeletingChildrenOnRemove; // Size: 0
};

struct __declspec(align(8)) C_PointCameraVFOV {
    char m_pad[1480];
    float32 m_flVerticalFOV; // Size: 0
};
...
struct __declspec(align(8)) CPointTemplate {
    ...
    char m_ScriptCallbackScope[0];
};

struct __declspec(align(8)) CRagdollManager {
    char m_pad[1384];
    int8 m_iCurrentMaxRagdollCount; // Size: 0
};
...
struct __declspec(align(8)) C_SoundEventEntity {
    ...
    char m_hSource[4];
    int32 m_nEntityIndexSelection; // Size: 0
    char m_bClientSideOnly[0];
};
...
struct __declspec(align(8)) C_SoundEventPathCornerEntity {
    char m_pad[1576];
    char m_vecCornerPairsNetworked[0];
};

struct __declspec(align(8)) C_BasePlayerPawn {
    char m_pad[4520];
    void* m_pWeaponServices;
    void* m_pItemServices;
    void* m_pAutoaimServices;
    void* m_pObserverServices;
    void* m_pWaterServices;
    void* m_pUseServices;
    void* m_pFlashlightServices;
    void* m_pCameraServices;
    char m_pMovementServices[16];
    char m_ServerViewAngleChanges[80];
    uint32 m_nHighestConsumedServerViewAngleChangeIndex; // Size: 4
    char v_angle[12];
    char v_anglePrevious[12];
    ...
    bool m_bIsSwappingToPredictableController; // Size: 0
};
...
struct __declspec(align(8)) CBasePlayerWeaponVData {
    ...
    char m_pad4_800[4];
    char m_aShootSounds[0];
};

struct  CClientAlphaProperty {
    char m_pad[16];
    uint8 m_nRenderFX; // Size: 1
    uint8 m_nRenderMode; // Size: 0
    char m_bAlphaOverride[0];
    char m_bShadowAlphaOverride[0];
    char m_nReserved[19];
    ...
    float32 m_flRenderFxDuration; // Size: 0
};
...
struct __declspec(align(8)) CLogicRelay {
    ...
    bool m_bPassthoughCaller; // Size: 0
};
...
struct __declspec(align(8)) C_PathParticleRope {
    ...
    char m_PathNodes_RadiusScale[0];
};
...
struct __declspec(align(8)) C_LightGlow {
    ...
    char m_pad4_3400[4];
    char m_GlowOverlay[0];
};

struct __declspec(align(8)) C_SpotlightEnd {
    char m_pad[3368];
    float32 m_flLightScale; // Size: 4
    float32 m_Radius; // Size: 0
};
...
struct __declspec(align(8)) C_PointValueRemapper {
    ...
    Vector m_vecPreviousTestPoint; // Size: 0
};
...
struct __declspec(align(8)) CCitadelSoundOpvarSetOBB {
    ...
    int32 m_nAABBDirection; // Size: 0
};

struct __declspec(align(8)) C_HandleTest {
    char m_pad[1384];
    char m_Handle[4];
    bool m_bSendHandle; // Size: 0
};
...
struct __declspec(align(8)) C_EntityDissolve {
    ...
    bool m_bLinkedToServerEnt; // Size: 0
};
...
struct __declspec(align(8)) C_EnvDecal {
    ...
    char m_pad1_3396[1];
    float32 m_flDepthSortBias; // Size: 0
};
...
struct __declspec(align(8)) C_SceneEntity {
    ...
    float32 m_flCurrentTime; // Size: 0
};
...
struct __declspec(align(8)) C_Sun {
    ...
    float32 m_flFarZScale; // Size: 0
};

struct __declspec(align(8)) C_BaseTrigger {
    char m_pad[3368];
    bool m_bDisabled; // Size: 1
    bool m_bClientSidePredicted; // Size: 0
};
...
struct __declspec(align(8)) C_TriggerPhysics {
    ...
    bool m_bConvertToDebrisWhenPossible; // Size: 0
};
...
struct __declspec(align(8)) CInfoOffscreenPanoramaTexture {
    ...
    bool m_bCheckCSSClasses; // Size: 0
};

struct __declspec(align(8)) CBombTarget {
    char m_pad[3376];
    bool m_bBombPlantedHere; // Size: 0
};
...
struct __declspec(align(8)) C_TriggerBuoyancy {
    char m_pad[3376];
    char m_BuoyancyHelper[128];
    float32 m_flFluidDensity; // Size: 0
};

struct __declspec(align(8)) CFuncWater {
    char m_pad[3368];
    char m_BuoyancyHelper[0];
};
...
struct __declspec(align(8)) C_CSObserverPawn {
    char m_pad[5392];
    char m_hDetectParentChange[0];
};

struct __declspec(align(8)) C_FootstepControl {
    char m_pad[3376];
    void* m_source;
    char m_destination[0];
};
...
struct __declspec(align(8)) C_FuncConveyor {
    ...
    float32 m_flCurrentConveyorSpeed; // Size: 0
};
...
struct __declspec(align(16)) C_Inferno {
    ...
    float32 m_flLastGrassBurnThink; // Size: 0
};
...
struct __declspec(align(8)) CBaseProp {
    ...
    char m_pad3_3988[3];
    char m_mPreferredCatchTransform[0];
};

struct __declspec(align(8)) C_BreakableProp {
    char m_pad[4040];
    char m_CPropDataComponent[64];
    char m_OnBreak[40];
    ...
    char m_hFlareEnt[4];
    bool m_noGhostCollision; // Size: 0
};
...
struct __declspec(align(8)) C_DynamicProp {
    ...
    Vector m_vecCachedRenderMaxs; // Size: 0
};
...
struct __declspec(align(8)) C_PointCommentaryNode {
    ...
    bool m_bRestartAfterRestore; // Size: 0
};
...
struct __declspec(align(8)) C_Precipitation {
    ...
    char m_pad1_3452[1];
    int32 m_nAvailableSheetSequencesMaxIndex; // Size: 0
};

struct __declspec(align(8)) C_FireSprite {
    char m_pad[3640];
    Vector m_vecMoveDir; // Size: 12
    bool m_bFadeFromAbove; // Size: 0
};
...
struct __declspec(align(8)) C_Fish {
    ...
    float32 m_averageError; // Size: 0
};

struct __declspec(align(8)) C_PhysicsProp {
    char m_pad[4368];
    bool m_bAwake; // Size: 0
};
...
struct __declspec(align(8)) C_BasePropDoor {
    ...
    char m_closedAngles[12];
    char m_hMaster[4];
    Vector m_vWhereToSetLightingOrigin; // Size: 0
};
...
struct __declspec(align(8)) C_RagdollProp {
    ...
    char m_worldSpaceBoneComputationOrder[0];
};
...
struct __declspec(align(8)) C_LocalTempEntity {
    ...
    char m_vecTempEntAngVelocity[12];
    ...
    char m_pad4_4072[4];
    void* m_pszImpactEffect;
    void* m_pszParticleEffect;
    ...
    Vector m_vecTempEntAcceleration; // Size: 0
};
...
struct __declspec(align(8)) C_EconEntity {
    ...
    char m_pad4_4408[4];
    void* m_flFlexDelayedWeight;
    bool m_bAttributesInitialized; // Size: 8
    char m_pad7_4424[7];
    char m_AttributeManager[1192];
...
struct __declspec(align(8)) C_BaseCSGrenadeProjectile {
    ...
    float32 m_flTrajectoryTrailEffectCreationTime; // Size: 0
};
...
struct __declspec(align(8)) C_PlantedC4 {
    ...
    void* m_pPredictionOwner;
    Vector m_vecC4ExplodeSpectatePos; // Size: 12
    char m_vecC4ExplodeSpectateAng[12];
    float32 m_flC4ExplodeSpectateDuration; // Size: 0
};
...
struct __declspec(align(8)) C_BaseCombatCharacter {
    ...
    float32 m_flWaterNextTraceTime; // Size: 0
};
...
struct  C_CSWeaponBase {
    ...
    char m_IronSightController[176];
    ...
    float32 m_flWatTickOffset; // Size: 0
};
...
struct __declspec(align(16)) C_CSWeaponBaseGun {
    ...
    bool m_bNeedsBoltAction; // Size: 0
};
...
struct __declspec(align(16)) C_WeaponTaser {
    char m_pad[6960];
    char m_fFireTime[4];
    int32 m_nLastAttackTick; // Size: 0
};
...
struct __declspec(align(16)) C_WeaponShield {
    char m_pad[6960];
    float32 m_flDisplayHealth; // Size: 0
};

struct __declspec(align(8)) C_MolotovProjectile {
    char m_pad[4616];
    bool m_bIsIncGrenade; // Size: 0
};
...
struct __declspec(align(8)) C_DecoyProjectile {
    ...
    char m_flTimeParticleEffectSpawn[0];
};
...
struct __declspec(align(8)) C_SmokeGrenadeProjectile {
    ...
    bool m_bSmokeEffectSpawned; // Size: 0
};
...
struct  C_BaseCSGrenade {
    ...
    char m_hSwitchToWeaponAfterThrow[0];
};

struct  C_WeaponBaseItem {
    char m_pad[6928];
    char m_SequenceCompleteTimer[24];
    bool m_bRedraw; // Size: 0
};

struct __declspec(align(8)) C_ItemDogtags {
    char m_pad[5992];
    char m_OwningPlayer[4];
    char m_KillingPlayer[0];
};
...
struct __declspec(align(16)) C_Fists {
    ...
    char m_pad3_6932[3];
    char m_nUninterruptableActivity[0];
};
...
struct __declspec(align(8)) C_CSPlayerPawnBase {
    char m_pad[4960];
    void* m_pPingServices;
    void* m_pViewModelServices;
...
struct __declspec(align(16)) C_CSGO_PreviewPlayer {
    ...
    void* m_animgraph;
    void* m_animgraphCharacterModeString;
    float32 m_flInitialModelScale; // Size: 0
};
